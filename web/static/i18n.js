...
const I18N = {
  ru: {
    ...
    'res.hardening_score': 'Оценка защищённости',
    'res.pass': 'ПРОЙДЕНО',
    'res.fail': 'ОШИБКА',
    'res.na': 'Н/Д',
    ...
    'res.severity.ok': 'ок',
    'res.no_findings': 'находок нет — проверка выполнена успешно',
  ...
  en: {
    ...
    'res.severity.ok': 'ok',
    'res.no_findings': 'No findings — check completed successfully.',
